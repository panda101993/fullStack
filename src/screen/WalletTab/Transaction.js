...
export default class Transaction extends Component {
    ...
    withdrawView = () => {
        ...
        Api(this.state.token, `wallet/wallet/get-withdrawlist?page=0&pageSize=100&coinName=${this.state.coinname}`, "GET")
            .then(resp => {
    ...
    render() {
        return (
            <View style={{ flex: 1, }}>
                ...
                <CustomHeader text1={"Transaction History"} source1={back} onPress1={() => this.props.navigation.goBack()} />
